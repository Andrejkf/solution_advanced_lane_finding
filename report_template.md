...
In here, an assumtion that the images correspond to a camera located on the center was done. So *pixel units* are *transformed to meters* and then the difference to the center of the image was computed.
...
* It would be very good to try other aproaches for *low curvature radius* road lane lines values  like *splines* or *high dimensi order wavelets generation*.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkxNzY3Mzk5MiwxMDM1NTE4NzMzLC0xOD
...
MTcsMTE2MDYwOTY4NSwtMTgwMDU0ODE3MCw1OTY2ODQ2OTIsNT
kxNzk2NjIxLDE2MjU5OTM0NDMsMTM4MDAzMjg4Nyw1MzY4MzA5
MzddfQ==
-->