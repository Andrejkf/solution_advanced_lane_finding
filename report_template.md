...
Initially I tried to use a color combination using a yellow_white color mask between HSV and HSL color spaces, but then I noticed that 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMDgzNDM1MjAsMTA3MzE0MzkzNSwxMD
