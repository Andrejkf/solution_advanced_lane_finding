...
3.1.1. Function generate_vertices(): (Cell 40 in Jupyter notebook). Was defined to set up the trapezoidal vertices of the region of interest 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM2MDk4OTEyOCwtMTYxNzY4NDQ5MSwtMT
