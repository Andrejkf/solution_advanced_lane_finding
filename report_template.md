...
* It would be very good to try other aproaches for low curvature radius values roads line like *splines* or *high order wavelets generation*.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA2MDQwMTg1LDQzODU3MTUxOCwtMTA3Mj
