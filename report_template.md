...
To get the camera matrix and distortion coefficients in file *camera_calibration_final.py* class *CalibratorCamera* was defined. It has 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk4NDA5MDU2MywxNTI1NTM5NzYyLDIxMz
