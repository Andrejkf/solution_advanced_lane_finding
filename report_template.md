...
* gray_binary(): (cell 29 jupyter notebook). Used to get a binary thresholded image from images im grayscale. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM4NjI2NTk4OSwxMjEzMDQ4NTU1LDEwNz
