...
3. find the chess inner corners using cv2.findChessboardCorners.
4. Get a list of object points and image points.
5. get camera matrix and distortion coeffients using cv2.calibrateCamera.
6. If wanted additional 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjExOTE4NjczMSwxNTI1NTM5NzYyLDIxMz
