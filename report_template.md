...
5.2.1. A Function named *estimatedistancefromlane()* was defined. (Cell 64 Jupyter notebook). Used to estimate vehicle distance from center.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTMxNDg2NzI3NSwxMTYwNjA5Njg1LC0xOD
